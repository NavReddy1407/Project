...
window.iconbitmap("C:/Users/STD017/Downloads/Project-11-Grade-main/Project-11-Grade-main/icon.ico")
...
def login_screen():
    ...
    login.iconbitmap("C:/Users/STD017/Downloads/Project-11-Grade-main/Project-11-Grade-main/icon.ico")
    login.resizable(False,False)

    username = Label(login,text='Enter your name:',font=('Bahnschrift SemiBold SemiCondensed', 24), fg = 'white', bg='black')
    username.place(x=170, y=60)

    username_box= Entry(login,width=20, font=('Arial', 15))
    username_box.place(x=170,y=120)

    dob = Label(login,text='Enter your date of birth:',font=('Bahnschrift SemiBold SemiCondensed', 24), fg = 'white', bg='black')
    dob.place(x=140, y=210)


    my_pics =PhotoImage(file= 'Logoo.gif')
    resizeds = my_pics.resize((500,500))
    new_pics = ImageTk.PhotoImage(resizeds)

    logos = Label(login, image=new_pics, bg='yellow')
    logos.pack()
    ...
    close = Button(login, text='>>>',bg='black', fg='white', command=open)
...
def open():
    ...
    options.iconbitmap("C:/Users/STD017/Downloads/Project-11-Grade-main/Project-11-Grade-main/icon.ico")
...
def bmi_window():
    ...
    calc.iconbitmap("C:/Users/STD017/Downloads/Project-11-Grade-main/Project-11-Grade-main/icon.ico")
...
def health_start():
    ...
    hs_calc.iconbitmap("C:/Users/STD017/Downloads/Project-11-Grade-main/Project-11-Grade-main/icon.ico")
...
def sugar_win():
    ...
    sugar_gen.iconbitmap("C:/Users/STD017/Downloads/Project-11-Grade-main/Project-11-Grade-main/icon.ico")
...
def workout_win():
    ...
    workout_screen.iconbitmap("C:/Users/STD017/Downloads/Project-11-Grade-main/Project-11-Grade-main/icon.ico")
...
my_pic = Image.open('C:/Users/STD017/Downloads/Logoo.png')
...
next_button = Button(window, text='>>>', bg='black', fg='white', command=login_screen)
next_button.place(x=500,y=640)
